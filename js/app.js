        ...
        function rangeInit() {
            ...
            ratingFilters.forEach((ratingFilter => {
                if (ratingFilter) {
                    ...
                    if (!container) {
                        console.error("Не найден родительский контейнер для ползунка:", ratingFilter);
                        return;
                    }
                    ...
                    if (!priceStart || !priceEnd || !resetButton) {
                        console.error("Не найдены необходимые элементы для ползунка:", ratingFilter);
                        return;
                    }
...
***************************************************************************** */
        ...
        if (filterButtonMob) {
            ...
            filterButtonMob.addEventListener("click", (function() {
            ...
            document.addEventListener("click", (function(event) {
                filterContents.forEach((filterContent => {
                    if (!filterContent.contains(event.target) && !filterButtonMob.contains(event.target)) closeFilters(filterContent);
                }));
            }));
        }
